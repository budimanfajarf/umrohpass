<header id="header"
  class="banner header sticky top-0 bg-white z-50 transition-all duration-300 drop-shadow-sm shadow-sm">
...
{{-- Mobile Menu --}}
@if (has_nav_menu('primary_navigation'))
  <div id="mobile-menu" class="fixed top-0 pt-20 md:pt-[110px] bg-white hidden w-full z-10 drop-shadow-sm shadow-sm">
